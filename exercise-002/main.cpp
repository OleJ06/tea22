...
/* .bss Segment */
static int foo;                                         // Variablendeklaration // static nur innerhalb des Übersetzungsmoduls
int foo2 = 0;
...
void doSomething (int value) {                          // call by value (Gültigkeit nur innerhalb der Funktion)
    value = value + 1;
...
int* doReturnAPtr () {                          
    ...
    return &value;                                      // das hier vermeiden (kein Zeiger auf eine Funktionslokale Variable zurückliefern) 
}
...
auto main(int argc, char **argv) -> int
{
    ...
    fmt::print("The value of bar after returnedPtr content after doReturnAPtr is: {}\n", *returnedPtr);
    doSomething(42);
    fmt::print("The value of bar after returnedPtr content after doReturnAPtr is: {}\n", *returnedPtr);
...
fmt::print("Value of foo     {} address of foo {}\n", foo, fmt::ptr(&foo));         // Die Adresse ist random 
...
fmt::print("Value of var2  {} address of var2 {}\n", var2, fmt::ptr(&var2)); 
    ...
    return 0; /* exit gracefully*/                      // Klausur: Was ist hier die Ausgabe?
}
